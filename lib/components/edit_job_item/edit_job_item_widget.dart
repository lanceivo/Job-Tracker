...
import 'edit_job_item_model.dart';
export 'edit_job_item_model.dart';

class EditJobItemWidget extends StatefulWidget {
  const EditJobItemWidget({
    super.key,
  ...
  @override
  State<EditJobItemWidget> createState() => _EditJobItemWidgetState();
}

class _EditJobItemWidgetState extends State<EditJobItemWidget> {
  late EditJobItemModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditJobItemModel());
  ...
  Widget build(BuildContext context) {
    return Align(
      ...
      child: StreamBuilder<JobApplicationRecord>(
        stream: JobApplicationRecord.getDocument(widget.jobItem!),
        builder: (context, snapshot) {
          ...
          final containerJobApplicationRecord = snapshot.data!;
                                          ...
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              controller: _model
                                                  ...
                                                  TextEditingController(
                                                text: containerJobApplicationRecord
                                                            .salaryRange !=
                                                        'null'
                                                    ? containerJobApplicationRecord
                                                        .salaryRange
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  controller: _model.notesTextController ??=
                                      TextEditingController(
                                    text: containerJobApplicationRecord.notes !=
                                            'null'
                                        ? containerJobApplicationRecord.notes
                                        : '',
                                  ),
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  await widget.jobItem!
                                    ...
                                    salaryRange: valueOrDefault<String>(
                                      _model.salaryTextController.text,
                                      'null',
                                    ),
                                    jobPostingUrl: valueOrDefault<String>(
                                      _model.linkTextController.text,
                                      'null',
                                    ),
                                    currentStatus: _model.statusValue,
                                    applicationDate: _model.datePicked != null
                                        ? _model.datePicked
                                        : getCurrentTimestamp,
                                    contactPerson: valueOrDefault<String>(
                                      _model.contactpersonTextController.text,
                                      'null',
                                    ),
                                    contactEmail: valueOrDefault<String>(
