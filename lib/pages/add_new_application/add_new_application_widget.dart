...
import 'add_new_application_model.dart';
export 'add_new_application_model.dart';

class AddNewApplicationWidget extends StatefulWidget {
  const AddNewApplicationWidget({super.key});

  static String routeName = 'add_new_application';
  static String routePath = '/addNewApplication';

  @override
  State<AddNewApplicationWidget> createState() =>
      _AddNewApplicationWidgetState();
}

class _AddNewApplicationWidgetState extends State<AddNewApplicationWidget> {
  late AddNewApplicationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddNewApplicationModel());

    _model.companyNameTextController ??= TextEditingController();
    _model.companyNameFocusNode ??= FocusNode();

    _model.positionTitleTextController ??= TextEditingController();
                              ...
                              builder: (context) {
                                if (!_model.applicationDone) {
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: TextFormField(
                                                          ...
                                                          decoration:
                                                            ...
                                                            hintText:
                                                                'Add any additional notes about this application , interview details, company culture. etc..',
                                                            hintStyle:
                                                                FlutterFlowTheme.of(
                                                                        context)
                                                                    .labelMedium
                                  ...
                                  return Container(
                                    ...
                                    height: 170.0,
                                    decoration: BoxDecoration(
                                      color: Color(0xB4E3FBE3),
                                      borderRadius: BorderRadius.circular(15.0),
                                      border: Border.all(
                                        color: Color(0xFF82FB82),
                                      ),
                                    ),
                                    child: Padding(
                                      padding: EdgeInsets.all(15.0),
