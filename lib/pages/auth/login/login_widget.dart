...
class _LoginWidgetState extends State<LoginWidget> {
  ...
  void initState() {
    ...
    _model.confirpasswordTextController ??= TextEditingController();
    _model.confirpasswordFocusNode ??= FocusNode();
            ...
            children: [
              wrapWithModel(
                ...
                child: HeaderWidget(
                  ...
                  authName: _model.type == 'login'
                      ? 'Need an account?'
                      : 'Already have an account?',
                  authCallback: () async {
                    if (_model.type == 'login') {
                      _model.type = 'create';
                      safeSetState(() {});
                    } else {
                      _model.type = 'login';
              ...
              Expanded(
                child: Align(
                  ...
                  child: Padding(
                    ...
                    child: Builder(
                      builder: (context) {
                        if ((_model.type == 'login') || widget.isLogin) {
                          return Column(
                            mainAxisSize: MainAxisSize.max,
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  ...
                                                  child: TextFormField(
                                                    controller: _model
                                                        .confirpasswordTextController,
                                                    focusNode: _model
                                                        .confirpasswordFocusNode,
                                                    autofocus: false,
                                                    obscureText: !_model
                                                      ...
                                                      suffixIcon: InkWell(
                                                        ...
                                                        focusNode: FocusNode(
                                                            skipTraversal:
                                                                true),
                                                        child: Icon(
                                                          _model.confirpasswordVisibility
                                                              ? Icons
                                                                  .visibility_outlined
                                                              : Icons
                                                                  .visibility_off_outlined,
